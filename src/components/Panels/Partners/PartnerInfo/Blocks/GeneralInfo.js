                ...
                <Column style={{ width: '45%', marginBottom: '21px' }}>
                  <div style={{ width: '100%' }}>
                    ...
                    <InputAnchor
                      ...
                      onChange={(e) =>
                        dispatch(sendContragentValues('partnerName', e.target.value))
                      }
                    />
                  </div>
                  <div style={{ width: '100%' }}>
                ...
                <Column style={{ width: '45%', marginBottom: '21px' }}>
                  ...
                  <div style={{ width: '100%' }}>
                    ...
                    <InputAnchor
                      ...
                      placeholder="Бренд"
                      onChange={(e) => dispatch(sendContragentValues('brand', e.target.value))}
                    />
                  </div>
                </Column>
              </Row>
              ...
              <div style={{ width: '100%' }}>
                ...
                <SelectAnchor
                  ...
                  options={[
                    ...
                    { label: 'Рекламное агентство', value: 'Рекламное агентство' },

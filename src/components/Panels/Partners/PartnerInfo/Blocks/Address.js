      ...
      <BlockBody>
        <div style={{ width: '100%', marginBottom: '21px' }}>
          ...
          <InputGlobe
            ...
            onChange={(e) => dispatch(sendContragentValues('city', e.target.value))}
            placeholder="Город"
          />
        </div>
        <Row>
          <div style={{ width: '46%', marginBottom: '21px' }}>
            ...
            <InputDirections
              ...
              onChange={(e) => dispatch(sendContragentValues('district', e.target.value))}
              placeholder="Район"
            />
          </div>
          <div style={{ width: '46%', marginBottom: '21px' }}>
            ...
            <InputEnvelope
              ...
              onChange={(e) => dispatch(sendContragentValues('postalCode', e.target.value))}
              placeholder="Индекс"
            />
          </div>
        </Row>
        <div style={{ width: '100%', marginBottom: '21px' }}>
          ...
          <InputEnvelope
            ...
            onChange={(e) => dispatch(sendContragentValues('legalAddress', e.target.value))}
            placeholder={'Адрес'}
          />
        </div>
        <div style={{ width: '100%', marginBottom: '21px' }}>
          ...
          <InputHouse
            ...
            onChange={(e) => dispatch(sendContragentValues('physicalAddress', e.target.value))}
            placeholder="Адрес"
          />
        </div>
      </BlockBody>

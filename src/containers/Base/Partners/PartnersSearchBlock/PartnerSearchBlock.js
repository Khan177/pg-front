...
import {BreadCrumbs, ListHeader, ListTitle, Section, Title, TitleLogo} from "../PartnersList/PartnersStyles";
import Location from "./Components/Blocks/location";
import {
    InputWrapperPartner,
    InputWrapperPartnerTableContent,
...
export default function CreateNewParters(props) {
                        ...
                        <STabList>
                            {(props.index === 12) ?
                                <InputWrapperPartnerTableContent style={{width: "auto", marginRight: "19px"}}>
                                    ...
                                    />
                                    <SearchButtonTableContent>Найти</SearchButtonTableContent>
                                </InputWrapperPartnerTableContent> : null}
                            {(props.index === 2) ?
                                <BtnBrand>
                                    Привязать бренд
                                </BtnBrand> : null}
